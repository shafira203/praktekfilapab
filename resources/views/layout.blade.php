...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="https://biztechacademy.id/wp-content/uploads/2024/04/Panduan-Lengkap-Cara-Belajar-Laravel-dari-Dasar-Sampai-Mahir.jpg">
    ...
    <body>
        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <img src="https://placehold.co/600x400?text=Shafira+Beauty" width="200" height="50">
            </a>
            ...
            <a href="https://praktekfilapab-production.up.railway.app/admin/login" class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Login
